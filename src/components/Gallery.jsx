...
const polyureaPhotos = [
  'duz1','duz2','duz3','duz4','duz6','duz7','duz8','duz9',
  'duz10','duz11','duz12','duz13','duz14','duz15','duz16','duz17','duz18',
  'duz22','duz23',
].map((name) => ({ src: `/img2/${name}.jpg`, alt: `Polyurea uygulama ${name}` }))
...
function Lightbox({ src, onClose }) {
  ...
  return (
    <div className="lightbox-overlay" onClick={onClose} role="dialog" aria-modal="true">
      ...
      <img src={src} alt="Büyütülmüş görsel" onClick={(e) => e.stopPropagation()} />
    </div>
  )
}
      ...
      <div className="container">
        <div className="text-center mb-4">
          ...
          <p className="section-subtitle mt-2">
            Gerçekleştirdiğimiz polyurea ve poliüretan uygulamalarından fotoğraf ve videolar.
          </p>
        </div>
        ...
        {activeTab === 'photos' && (
          <>
            ...
            <h3 className="gallery-category-title mt-5">Poliüretan Köpük Çatı Uygulaması</h3>
        ...
        {activeTab === 'videos' && (
          <>
            <h3 className="gallery-category-title">Polyurea Su Yalıtımı</h3>
            <VideoGrid videos={polyureaVideos} />

            <h3 className="gallery-category-title mt-5">Poliüretan Köpük Çatı Uygulaması</h3>
            <VideoGrid videos={puVideos} />
          </>
        )}
      </div>
